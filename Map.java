...
MouseListener teamMember1skillListener = new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(skill == 1){
            bossStats.cHp(-10*calcDmg(team.getTeamMember(0).getStats().getAtk(),bossStats.getDef()));
            bigBossHp.setValue((int) (((double) bossStats.getHp()/bossStats.getBaseHp()) * 100));
        }
        else if(skill == 2){
            for(int i =0;i<5;i++){
...
MouseListener teamMember2skillListener = new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(skill == 1){
            bossStats.cHp(-5*mult*calcDmg(team.getTeamMember(1).getStats().getAtk(),bossStats.getDef()));
            bigBossHp.setValue((int) (((double) bossStats.getHp()/bossStats.getBaseHp()) * 100));
        }
        else if(skill == 2){
            for(int i =0;i<5;i++){
...
MouseListener teamMember3skillListener = new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(skill == 1){
            bossStats.cHp(-10*calcDmg(team.getTeamMember(2).getStats().getAtk(),bossStats.getDef()));
            bigBossHp.setValue((int) (((double) bossStats.getHp()/bossStats.getBaseHp()) * 100));
        }
        else if(skill == 2){
            for(int i =0;i<5;i++){
...
MouseListener teamMember4skillListener = new MouseAdapter() {
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(skill == 1){
            bossStats.cHp(-10*calcDmg(team.getTeamMember(3).getStats().getAtk(),bossStats.getDef()));
            bigBossHp.setValue((int) (((double) bossStats.getHp()/bossStats.getBaseHp()) * 100));
        }
        else if(skill == 2){
            for(int i =0;i<5;i++){
